	...
	<body>
		...
		<div id="show-product" class="content scaffold-show" role="main">
			...
			<ol class="property-list product">
				...
				<g:if test="${productInstance?.userSheep}">
				<li class="fieldcontain">
					<span id="userSheep-label" class="property-label"><g:message code="product.userSheep.label" default="User Sheep" /></span>
					
						<span class="property-value" aria-labelledby="userSheep-label"><g:link controller="userSheep" action="show" id="${productInstance?.userSheep?.id}">${productInstance?.userSheep?.encodeAsHTML()}</g:link></span>
